...
public sealed partial class uGUI_SceneIntro_IntroSequence_Patch : NitroxPatch, IDynamicPatch
{
    ...
    public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
    {
        return new CodeMatcher(instructions)
               ...
               .MatchEndForward(
                   new CodeMatch(OpCodes.Call, AccessTools.PropertyGetter(typeof(GameInput), nameof(GameInput.AnyKeyDown)))
               )
    ...
    private static bool IsRemoteCinematicReady(uGUI_SceneIntro uGuiSceneIntro)
    {
        ...
        if (!packetSend)
        {
            ...
            uGuiSceneIntro.mainText.SetText(Language.main.GetFormat("Nitrox_IntroWaitingPartner", "[ESC]"));
